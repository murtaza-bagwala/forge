...
| Mode | full | `--quick`, `--regression .forge/qa-reports/baseline.json` |
| Output dir | `.forge/qa-reports/` | `Output to /tmp/qa` |
...
3. Copy report template from `probe/templates/qa-report-template.md` to output dir
...
**Write each issue to the report immediately** using the template format from `probe/templates/qa-report-template.md`.
