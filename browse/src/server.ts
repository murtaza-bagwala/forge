/**
 * forge browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.forge/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.forge/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['forge browse — headless browser for AI agents', '', 'Commands:'];
